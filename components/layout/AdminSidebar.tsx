...
const ADMIN_NAV = [
  ...
  { href: "/admin/settings", label: "Audit & Settings", icon: Settings },
];
        ...
        >
          ...
          <div>
            <span className="font-bold text-sm text-slate-900 dark:text-white tracking-tight flex items-center gap-1">
              Admin Suite
              <span className="text-[9px] uppercase tracking-wider font-bold px-1.5 rounded-md bg-indigo-100 dark:bg-indigo-900/60 text-indigo-700 dark:text-indigo-300">
                Staff
              </span>
            </span>
