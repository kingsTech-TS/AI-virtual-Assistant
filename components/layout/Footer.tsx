...
import { GraduationCap, ShieldCheck, BookOpen, Headset } from "lucide-react";
    ...
    <footer className="border-t border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900/50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4 md:col-span-1">
            <div className="flex items-center gap-3">
              ...
              <span className="font-bold text-slate-900 dark:text-white">Academic Assist</span>
            </div>
            <p className="text-sm text-slate-500 dark:text-slate-400">
              Institutional AI assistance powered by university knowledge documents with automated human staff escalation.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-slate-500 dark:text-slate-400">
              <li>
                <Link href="/dashboard/chat" className="hover:text-blue-600 dark:hover:text-blue-400 transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-slate-500 dark:text-slate-400">
              <li>
                <Link href="/dashboard/tickets" className="hover:text-blue-600 dark:hover:text-blue-400 transition-colors">
                  Support Ticket Helpdesk
                </Link>
              </li>
              <li>
                <Link href="/#faqs" className="hover:text-blue-600 dark:hover:text-blue-400 transition-colors">
                  Verified FAQs
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-start gap-2 text-xs text-slate-500 dark:text-slate-400">
                ...
                <span>Answers verified strictly against uploaded university handbooks.</span>
              </div>
              <div className="flex items-start gap-2 text-xs text-slate-500 dark:text-slate-400">
              ...
              <div className="flex items-start gap-2 text-xs text-slate-500 dark:text-slate-400">
                ...
                <span>Direct escalation to course advisors & departmental staff.</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="mt-8 pt-6 border-t border-slate-200 dark:border-slate-800 flex flex-col sm:flex-row items-center justify-between text-xs text-slate-400">
          <p>© {new Date().getFullYear()} University Academic Virtual Assistant. All rights reserved.</p>
          <p className="mt-2 sm:mt-0">Powered by Next.js & FastAPI REST Architecture</p>
        </div>
      </div>
    </footer>
  );
